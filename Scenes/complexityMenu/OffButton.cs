...
public partial class OffButton : TextureButton
{
	/// <summary>
	...
	public override void _Ready()
	{
		...
		if (settings.getRoomComplexity() == 0) // disables this button if the room complexity is already 0.
		{
			this.Disabled = true;
		}
	}
	...
	void onPressed()
	{
		settings.setRoomComplexity(0); // calls "roomComplexity"'s setter function with parameter '0'
